...
return [
    'modules' => [
        ...
        'Ampersand_DisableStockReservation' => 0,
        ...
        'Rootways_Authorizecim' => 0,
        'Sitejabber_Reviews' => 1,
        'TA_InvalidAddressFix' => 1,
